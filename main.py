...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY')  # Use environment-based secret key
...
# Get Uploaded Videos for User and Topic
...
def save_exercise():
    try:
        ...
        if 'question_image' in data and data['question_image']:
            try:
                image_data = data['question_image'].split(',')[1]
...
# Get Exercises by Topic and User
...
# Serve Topic Videos (for students)
...
# Get Topic Exercises (for Students)
